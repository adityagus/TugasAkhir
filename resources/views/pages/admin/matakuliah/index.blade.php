    ...
    <section class="section">
      <div class="card">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          ...
          <li class="nav-item" role="presentation">
            <a class="nav-link active" id="profile-tab" href="{{ route('admin.matakuliah.index') }}" role="tab" aria-controls="matakuliah" aria-selected="true">Mata Kuliah</a>
          </li>
          <li class="nav-item" role="presentation">
            <a class="nav-link" id="profile-tab" href="{{ route('admin.laboratorium.index') }}" role="tab" aria-controls="laboratorium" aria-selected="true">Laboratorium</a>
          </li>
        </ul>
          ...
          <div>
            <a href="{{ route('admin.matakuliah.create') }}" >
              <button class='btn btn-primary mb-2' >
                <i class='bi bi-plus bi-sub'></i>Tambah Mata Kuliah
              </button>
            </a>
          </div>
        </div>
                ...
                <td>
                  <div class="d-flex justify-content-center">
                    ...
                    <span class='d-flex d-inline-block'>
                      <a href="{{ route('admin.matakuliah.edit', $item->id) }}" class="btn btn-info mx-2">
                        Edit
                      </a>
                    </span>
                    ...
                    <form action="{{ route('admin.matakuliah.destroy', $item->id )  }}" method="POST" class="d-inline">
                      @csrf
                      @method('delete')
                      <button type="button" class="btn btn-danger" data-bs-toggle='modal' data-bs-target="#{{ Str::slug($item->matakuliah) }}">
                        Delete
                      </button>
                      
                      <div class="modal fade" id="{{ Str::slug($item->matakuliah)  }}" aria-hidden="true" aria-hidden="true">
                          ...
                          <div class="modal-content">
                             <div class="modal-header">
                              ...
                              <div class="modal-body">
                                <p>Apakah {{ $item->matakuliah }} yakin dihapus ?</p>
                              </div>
