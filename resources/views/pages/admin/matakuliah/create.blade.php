    ...
    <div class="page-title">
      <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
          <h3>Menambahkan Mata Kuliah</h3>
          <p class="text-subtitle text-muted">Menambahkan Mata Kuliah di Jurusan Elektro</p>
        </div>
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form action="{{ route('admin.matakuliah.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="mb-4">
              <label for="matakuliah" class="form-label">Mata Kuliah Baru</label>
              <input type="text" class="form-control text-bold" name="matakuliah" value="{{ old('matakuliah') }}" id="matakuliah" placeholder="Masukan Mata Kuliah" >
            </div>
