        ...
        <div class="card-body display d-flex">
          ...
          <div class="descriptions d-flex flex-sm-column-reverse">
            ...
            <table>
              ...
              <tr>
                <td width='10%'>Kelas/Jabatan</td>
                <td width='5%'>:</td>
                <td width='0%'>{{ $mhs->kelas }}</td>
              </tr>

              <tr>
                <td width='10%'>NIM/NIP/NIK</td>
                <td width='5%'>:</td>
  ...
  <section class="row">
    <div class="col-12">
      <div class="row">
        ...
        <div class="col-6 col-lg-3 col-md-6">
          <div class="card max" style="min-height: 8rem">
            <div class="card-body px-3 py-4-5">
              <div class="row">
                <div class="col-md-4">
                ...
                <div class="col-md-8">
                  <h6 class="text-muted font-semibold">Mahasiswa Elektro</h6>
          ...
          <div class="card" style="min-height: 8rem">
            <div class="card-body px-3 py-4-5">
              <div class="row">
                ...
                <div class="col-md-8">
                  <h6 class="text-muted font-semibold">Meminjam</h6>
